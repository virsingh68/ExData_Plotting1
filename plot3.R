...
par(mar=c(8,6,2,2))
with(power_range,plot(Date_Time,Global_active_power,type='n',ylab="Energy Sub metering",xlab=""))
with(power_range,plot(Date_Time,Sub_metering_1,type='l',ylab="Energy Sub metering",xlab="" ))
